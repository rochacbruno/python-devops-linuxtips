...
$ /usr/bin/time -f "%M" cat text | uv run loganv1.py
# Output:
> 1516
# Total de linhas: 10001
```
...
- Via pipe, o sistema operacional gerencia o buffer de forma mais eficiente, o Kernel gerencia o tamanho do buffer, liberando memória conforme necessário, o Python não tem outra opção a não ser ler o que vem chunck a chunk do pipe, não tem o mesmo controle mas é mais eficiente em termos de memória.
