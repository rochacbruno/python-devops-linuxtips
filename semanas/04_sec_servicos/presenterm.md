...
<!-- font_size: 2 -->
Diagrama sequencial simplificado do handshake TLS/SSL
...
<!-- font_size: 4 --> 
## Continua no próximo video: Secrets management
...
Uma vez que o Trivy esteja instalado, você pode escanear qualquer imagem Docker local ou remota para vulnerabilidades conhecidas.
